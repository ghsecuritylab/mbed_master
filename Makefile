...
OBJECTS += Rs485/rs485.o
OBJECTS += Nodes/nodes.o
OBJECTS += Utils/crc.o
OBJECTS += Utils/hdlc_framer.o
OBJECTS += main.o
...
INCLUDE_PATHS += -I../
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I../Console
INCLUDE_PATHS += -I../Rs485
INCLUDE_PATHS += -I../Nodes
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1521401114.79
...
CXX_FLAGS += -fno-rtti
CXX_FLAGS += -DMBED_STACK_STATS_ENABLED
CXX_FLAGS += -DMBED_CONF_RTOS_PRESENT
CXX_FLAGS += -Wvla
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1521401114.79
